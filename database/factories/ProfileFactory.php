...
class ProfileFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'wife_work_status_id' => WifeWorkStatus::all()->random()->id,
            'wife_polygamy_status_id' => WifePolygamyStatus::all()->random()->id,
            'wife_study_status_id' => WifeStudyStatus::all()->random()->id,
            ...
            'polygamy_status_id' => PolygamyStatus::all()->random()->id,
