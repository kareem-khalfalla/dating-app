...
class CreateProfilesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('profiles', function (Blueprint $table) {
            ...
            $table->unsignedMediumInteger('country_of_residence')->nullable();
            ...
            $table->string('wife_work_status')->nullable();
            $table->string('wife_polygamy_status')->nullable();
            $table->string('wife_study_status')->nullable();
            $table->string('accept_wife_work_status')->nullable();
            $table->string('accept_wife_study_status')->nullable();
            ...
            $table->string('polygamy_status')->nullable();
