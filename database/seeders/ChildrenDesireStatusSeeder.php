...
class ChildrenDesireStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        $childrenDesireStatuses = [
            ['name' => ['en' => 'I would like it I would like it', 'ar' => 'أود ذلك', 'de' => 'Ich möchte es Ich möchte es']],
            ['name' => ['en' => 'I do not want it I do not want it', 'ar' => 'لا اريدها', 'de' => 'ich will es nicht ich will es nicht']],
