...
return [
    ...
    'attributes'           => [
        ...
        'selectedState'         => 'Provinzen',
        'country_of_residence'  => 'Aufenthaltsland',
        'nationality_id'        => 'Staatsangehörigkeit',
        'postal_code'           => 'Postleitzahl',
        'residence_status_id'   => 'Residenz',
        'relocate_status_id'    => 'Umzug an einen anderen Ort',
        'native_language_id'    => 'Die Muttersprache',
        'second_language_id'    => 'die zweite sprache',
        'third_language_id'     => 'dritte Sprache',
        'second_language_perfection_id' => 'Zweitsprachqualität',
        'third_language_perfection_id' => 'Die Qualität der dritten Sprache',
    ],
];