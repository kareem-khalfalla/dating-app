<div class="card card-body shadow">
    ...
    <!-- <form id="register-form" class="col-12 m-auto pt-3" method="post"> !-->
    ...
    <div class="row">
        ...
        <div class="input-group input-group-lg mb-3 col-md-6">
            ...
            <x-input id="rpassword" wire:model.defer="state.password" placeholder="password" type="password" />
        </div>
        <div class="input-group input-group-lg mb-3 col-md-6">
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-lg"><i class="fa fa-key"
            ...
            <x-input id="cpassword" wire:model.defer="state.password_confirmation" placeholder="cofirm password"
                type="password" />
