<div id="Personal_profile" class="col-lg-11 m-auto pb-4" wire:ignore>
    ...
    <form wire:submit.prevent="updateInfo" id="captcha_form" method="post" action="#">
        ...
        <div class="form-group">
            ...
            <textarea wire:model="state.partner_bio" class="form-control @error('partner_bio') is-invalid @enderror"
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.relationship_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.marriage_id" required="required" class="form-control form-control-lg ">
