<div id="the_shape" class="col-lg-11 m-auto pb-4" wire:ignore>
    ...
    <form wire:submit.prevent="updateInfo" id="captcha_form" class="row" method="post" action="#">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.body_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.skin_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.hair_color_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.hair_length_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.hair_kind_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.eye_color_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.eye_glass_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.health_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.psychological_pattern_id" required="required"
        ...
        <div class="form-group  mb-3 col-md-6">
            ...
            <textarea wire:model="state.clarification" class="form-control" id="exampleFormControlTextarea1"
                rows="3"></textarea>
        </div>
