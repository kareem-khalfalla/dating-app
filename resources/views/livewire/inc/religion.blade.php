<div id="Religious_status" class="col-lg-11 m-auto pb-4" wire:ignore.self>
    ...
    <form wire:submit.prevent="updateInfo" id="captcha_form" method="post" action="#">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model.defer="state.religion_method_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group">
            <label class="col-12">{{ __('settings.If you listen to the lessons, who will you listen
                to?') }}</label>
            <textarea wire:model.defer="state.lesson_listing"
                ...
                rows="3" placeholder="{{ __('settings.If you listen to the lessons, who will you listen to?') }}" maxlength="200"></textarea>
