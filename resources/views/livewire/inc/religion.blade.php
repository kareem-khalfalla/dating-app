<div id="Religious_status" class="col-lg-11 m-auto pb-4" wire:ignore>
    ...
    <form wire:submit.prevent="updateInfo" id="captcha_form" method="post" action="#">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.religion_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.method_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.obligation_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.prayer_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.alfajr_prayer_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.fasting_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.reading_quran_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.headdress_id" required="required" class="form-control form-control-lg ">
        ...
        {{-- <div class="input-group input-group-lg mb-3 ">
            <label class="col-12">Reading the Qoran</label>
            <select wire:model="state.veil_id" required="required" class="form-control form-control-lg ">
                <option disabled>Reading the Qoran</option>
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.robe_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.beard_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.tafaqah_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group">
            <label class="col-12">If you listen to the lessons, who will you listen
                to?</label>
            <textarea wire:model="state.listenToLesson" class="form-control" id="exampleFormControlTextarea1" rows="3"
                placeholder="If you listen to the lessons, who will you listen to?" maxlength="200"></textarea>
        </div>

        <div class="input-group input-group-lg mb-3 ">
            <label class="col-12">Listening to music</label>
            <select wire:model="state.music_status_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="input-group input-group-lg mb-3 ">
            ...
            <select wire:model="state.show_status_id" required="required" class="form-control form-control-lg ">
