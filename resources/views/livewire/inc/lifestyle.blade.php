<div id="their_lifestyle" class="col-lg-11 m-auto pb-4" wire:ignore>
    ...
    <form wire:submit.prevent="updateInfo" id="captcha_form" class="row" method="post" action="#">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.smoke_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.alcohol_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.halal_food_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state." required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group mb-3 col-md-6">
            ...
            <select wire:model="state.hobby_id" required="required" class="form-control form-control-lg ">
        ...
        <div class="form-group  mb-3 col-md-6">
            ...
            <textarea wire:model="state.books" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>

        <div class="form-group  mb-3 col-md-6">
            <label for="exampleFormControlTextarea1">favorite places</label>
            <textarea wire:model="state.places" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>

        <div class="form-group  mb-3 col-md-6">
            <label for="exampleFormControlTextarea1">Other interests</label>
            <textarea wire:model="state.interests" class="form-control @error('interests') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3"></textarea>
            @error('interests')
